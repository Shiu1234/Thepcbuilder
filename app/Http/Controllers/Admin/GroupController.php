...
return redirect()->back()->with('status','Group data added successfully');
    ...
    public function delete(Request $request , $id){
      ...
      $group = Groups::find($id);
        ...
        $group->update();
        return redirect()->back()->with('status','data deleted success');
  ...
  return view('admin.collection.group.deletedrecords')
  ->with('group' , $group)
  ;
    ...
    public function deletedrestore($id){
      ...
      $group = Groups::find($id);
        ...
        $group->update();
        return redirect('group')->with('status','data deleted success');
